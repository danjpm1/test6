    ...
    <div className="w-full overflow-x-hidden bg-white">
      ...
      <section className="bg-white py-16 md:py-20 lg:py-24">
        <div className="max-w-4xl mx-auto px-6 md:px-12">
          <div className="border border-gray-100 rounded-lg p-8 md:p-10 lg:p-12">
            {/* Quote icon */}
            ...
            <div className="flex items-center gap-4">
              ...
              <div>
                <p className="font-medium text-black text-[15px] md:text-[16px]">Sorin Isparesescu</p>
                <p className="text-gray-500 text-[13px] md:text-[14px]">CEO, Pain Clinic · Commercial Renovation</p>
              </div>
            </div>
          </div>
        </div>
