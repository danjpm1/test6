              ...
              <div className="grid lg:grid-cols-2 gap-6 lg:gap-8">
                ...
                <div className="bg-white lg:bg-transparent p-6 lg:p-8 rounded-lg">
                  ...
                  <div className="flex gap-3 mb-8">
                    ...
                    <Link href={`/services/${section.id === 'consulting-engineering' ? 'engineering-consulting' : section.id === 'financing' ? 'engineering-consulting' : section.id === 'new-builds' ? 'new-builds' : section.id === 'remote' ? 'remote-work' : section.id === 'commercial' ? 'commercial-projects' : section.id}`}>
