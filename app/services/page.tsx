      ...
      <section className="py-20 lg:py-28 bg-black">
        <div className="px-4 lg:px-8 xl:px-12 w-full max-w-[1800px] mx-auto mb-32 lg:mb-40">
          <div className="flex flex-col sm:flex-row sm:items-end sm:justify-between gap-4 mb-16">
            ...
            <Link 
              href="/offers"
              className="group flex items-center gap-2 text-[#c6912c] hover:text-white transition-colors"
            >
              <span className="text-sm font-medium tracking-wide">View All Offers</span>
              <svg 
