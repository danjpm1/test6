      ...
      <section className="py-20 lg:py-28 bg-black">
        <div className="px-4 lg:px-8 xl:px-12 w-full max-w-[1800px] mx-auto mb-32 lg:mb-40">
          <div className="flex flex-col sm:flex-row sm:items-end sm:justify-between gap-6 mb-16">
            ...
            <Link href="/offers">
              <button className="flex items-center gap-3 px-8 py-4 bg-[#c6912c] hover:bg-[#a67923] text-black font-semibold text-base rounded-[4px] transition-all hover:scale-105 hover:shadow-lg hover:shadow-[#c6912c]/30 whitespace-nowrap">
