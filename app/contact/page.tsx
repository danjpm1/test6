    ...
    <div className="min-h-screen bg-black">
      ...
      <section className="relative bg-[#0a0a0a] py-24 mt-20 overflow-hidden">
        ...
        <div className="relative max-w-5xl mx-auto px-6">
          ...
          <div className="mb-10">
            ...
            <button
              onClick={() => navigator.clipboard.writeText("danghel@ymail.com")}
            ...
            >
              <span className="text-white text-lg font-mono">danghel@ymail.com</span>
      ...
      <section id="booking" className="bg-gray-50 py-20">
        <div className="max-w-4xl mx-auto px-6">
          <iframe
            src="https://koalendar.com/e/meet-with-antova-builders?embed=true"
            width="100%"
            height="700"
            frameBorder="0"
